...
from bot import (config_dict, dispatcher, user_data, tgBotMaxFileSize,
                 aria2, LOGGER, status_reply_dict_lock, Interval, aria2_options,
                 aria2c_global, download_dict, qbit_options, get_client, 
                 DATABASE_URL, GLOBAL_EXTENSION_FILTER, DRIVES_IDS, DRIVES_NAMES,
                 INDEX_URLS, CATEGORY_IDS, CATEGORY_INDEXS, CATEGORY_NAMES)
