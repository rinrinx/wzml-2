...
default_values = {'AUTO_DELETE_MESSAGE_DURATION': 30,
                  ...
                  'START_BTN1_URL': 'https://t.me/turkleechh',
                  'START_BTN2_NAME': 'Support Group',
                  'START_BTN2_URL': 'https://t.me/turkleechh',
                  'AUTHOR_NAME': 'WZML',
                  'AUTHOR_URL': 'https://t.me/turkleechh',
                  'TITLE_NAME': 'WeebZone',
                  'GD_INFO': 'turkleechh Mirror Bot',
                  'CREDIT_NAME': 'turkleechh',
                  'NAME_FONT': 'code',
                  'CAPTION_FONT': 'code',
                  'FINISHED_PROGRESS_STR': '█',
                  'UN_FINISHED_PROGRESS_STR': '▒',
                  'MULTI_WORKING_PROGRESS_STR': '▁ ▂ ▃ ▄ ▅ ▆ ▇'.split(' '),
                  'CHANNEL_USERNAME': 'turkleechh',
                  'FSUB_CHANNEL_ID': '',
                  'IMAGE_URL': '',
