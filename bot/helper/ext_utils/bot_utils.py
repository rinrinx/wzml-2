...
from bot import download_dict, download_dict_lock, botStartTime, DOWNLOAD_DIR, user_data, config_dict, CATEGORY_NAMES, btn_listener
...
def check_buttons():
    if len(btn_listener) >= 5:
        return 'Sorry, I can only handle 5 tasks at a time.'    
